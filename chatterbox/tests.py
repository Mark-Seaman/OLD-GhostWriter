...
class GhostTest(DjangoTest):
    ...
    def test_project(self):
        ...
        self.assertEqual(x, '/Users/seaman/Hammer/Documents/Shrinking-World-Pubs/GhostWriter/AI')
    ...
    def test_outline(self):
        text = pub_script_command('outline', ['GhostWriter','Chapter2', 'Chapter2.md', '2.1'])
    ...
    def test_chatgpt(self):
        x = pub_script_command('chatgpt', ['GhostWriter', 'Pub', 'TOC.md', 'TOC.ai', False])
        y = ''
        print(x)
        # self.assertEqual(x, y)

    def test_outline_expander(self):
        print(pub_script_command('expand', ['GhostWriter', 'Chapter2', 'Chapter2.md']))